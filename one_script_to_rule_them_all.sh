...
echo "touch /home/jline/t2.txt" | at 05:40
echo "echo \"# TILE2 PI #\" >> /home/jline/t2.txt" |at 05:41
echo "echo \" \" >> /home/jline/t2.txt" |at 05:42
echo "echo \"[05:30AM]: Sourced one_script_to_rule_them_all.sh \" >> /home/jline/t2.txt" |at 05:43
...
echo "echo \"[06:00AM]: A new day of spying on satellites begins \" >> /home/jline/t2.txt" |at 05:55
echo "echo \"[06:02AM]: Checking for missing data files from the last 24 hours.\" >> /home/jline/t2.txt" | at 06:02
at 06:03 < /home/jline/check_missing.sh
at 06:04 < /home/jline/do_rsync_clear.sh

echo "scp /home/jline/t2.txt achokshi@ozstar.swin.edu.au:/fred/oz048/achokshi/mwa_sats/data/status" | at 06:23

# Clean up and get ready for next day
echo "rm /home/jline/t2.txt" | at 06:25
